...
public class ColourSelecter extends JDialog {
	...
	/**
	 * This class only deals with the colour selecter pop up windows. This is made visable
	 * through the text class and allows the user to select a colour
	 */
	...
	public ColourSelecter() {
		...
		/**
		 * Add all buttons to the window. Each button closes the window and 
		 * returns the selected value for the text class.
		 */
