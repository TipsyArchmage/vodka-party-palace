...
public class VideoPlayback extends JPanel{
	...
	public VideoPlayback() {
		...
		//Panel that shows the current selected video
				//mainGUI.currentVideoPanel = new JPanel();
				//mainGUI.currentVideoPanel.setBounds(427, 24, 259, 45);
				//mainGUI.contentPane.add(mainGUI.currentVideoPanel);
				//mainGUI.currentVideoPanel.setLayout(null);
				//Label for section
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (exitValue == JFileChooser.APPROVE_OPTION) {
							...
							try {
								...
								System.out.print(mainGUI.currentSelectedVideoFile.toString());
